...
#
#   Generated Fri Dec  2 18:47:11 2016  by diboye
#
#====================================
...
#cmt_local_tagfile_check_install_python_modules = $(ZdZdPlotting_tag)_check_install_python_modules.make
cmt_local_tagfile_check_install_python_modules = $(bin)$(ZdZdPlotting_tag)_check_install_python_modules.make
...
#cmt_local_tagfile_check_install_python_modules = $(ZdZdPlotting_tag).make
cmt_local_tagfile_check_install_python_modules = $(bin)$(ZdZdPlotting_tag).make
...
#cmt_final_setup_check_install_python_modules = $(bin)ZdZdPlotting_check_install_python_modulessetup.make
...
#cmt_final_setup_check_install_python_modules = $(bin)ZdZdPlottingsetup.make
cmt_local_check_install_python_modules_makefile = $(bin)check_install_python_modules.make
...
$(check_install_python_modulesactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/AthAnalysisBase/x86_64-slc6-gcc49-opt/2.4.22/AthAnalysisBase/2.4.22/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../python *.py ' -installdir=/afs/cern.ch/work/d/diboye/ZdZdTestArea/InstallArea/python/ZdZdPlotting -level=
