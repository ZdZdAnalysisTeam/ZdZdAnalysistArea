...
#       use CxxUtils CxxUtils-* Control (no_version_directory)
#   use AthAnalysisBaseComps AthAnalysisBaseComps-* Control (no_version_directory)
# use GeneralCamTools GeneralCamTools-* PhysicsAnalysis/AnalysisCam/AnalysisCamTools (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use GaudiInterface GaudiInterface-* External (no_version_directory)
#   use AnalysisCamEvent AnalysisCamEvent-* PhysicsAnalysis/AnalysisCam (no_version_directory)
...
use GeneralCamTools GeneralCamTools-02-00-00-branch PhysicsAnalysis/AnalysisCam/AnalysisCamTools (/afs/cern.ch/work/d/diboye/ZdZdTestArea)
...
ROOTMathLibs (from package AtlasROOT) applied [xAODBase AnalysisCamEvent AnalysisCamROOT] activated xAODBase
...
no_pack_dist_check (from package ZdZdPlotting) applied [ZdZdPlotting]
----------> CMTPATH
